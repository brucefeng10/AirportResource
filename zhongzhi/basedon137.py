...
with open('hbhd274-25.txt','r') as f4:
    for line in f4:
...
passenger=passen[0]
near=nearjwhd[0]
hdtype=nearjwhd[3]#25滑道计算
is_linshi=nearjwhd[2]

sol=[]
with open('sol137.txt','r') as f6:
    for line in f6:
        sol.append(map(float,line.split(',')))
